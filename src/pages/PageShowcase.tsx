...
const cards: Array<ShowcaseCardProps> = [
  {
    ...
    text: `My "professional" developer portfolio website. Made with React, Chakra UI, and a heap of libraries.\n\nThis was fun (and funny) to make and I learned quite a bit about component frameworks and handling svg files/data. Also, I find it amusing that I'm showcasing my website on my website. 😝`
  },
  {
    title: 'Pytris',
    img: img_pytris,
